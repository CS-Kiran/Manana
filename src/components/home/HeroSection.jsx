...
export default function HeroSection() {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-4 md:px-10 pb-16 pt-10 overflow-hidden">
      ...
      <div className="absolute top-20 -left-64 w-96 h-96 bg-teal-400/20 rounded-full filter blur-3xl opacity-30 dark:opacity-10 animate-blob"></div>
      <div className="absolute bottom-20 -right-64 w-96 h-96 bg-violet-600/20 rounded-full filter blur-3xl opacity-30 dark:opacity-10 animate-blob animation-delay-4000"></div>
      ...
      >
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-8 bg-gradient-to-r from-teal-500 to-violet-600 bg-clip-text text-transparent drop-shadow-lg">
          ...
          >
            <Link href="/login">
              <motion.button
                className="rounded-full bg-gradient-to-r from-teal-500 to-violet-600 text-white font-semibold transition-all duration-300 shadow-lg w-fit px-8 py-3 text-lg relative overflow-hidden group"
                whileHover={{ scale: 1.05, boxShadow: "0 10px 25px rgba(0, 0, 0, 0.2)" }}
                whileTap={{ scale: 0.98 }}
              >
                <span className="relative z-10">Get Started</span>
                <span className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-violet-600 to-teal-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
              </motion.button>
            </Link>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-teal-300/20 to-violet-400/20 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          <motion.div 
          ...
          >
            <div className="relative w-full h-full">
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-teal-500/10 to-violet-600/10 mix-blend-overlay"></div>
