      ...
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-background via-secondary/20 to-accent/30 p-4">
        <Card className="w-full max-w-md shadow-2xl rounded-xl bg-card/90 backdrop-blur-lg border-border/50 hover:shadow-3xl transition-shadow duration-300">
          ...
          <CardContent className="space-y-4">
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`transition-all ${errors.name ? 'border-destructive focus:ring-destructive' : 'focus:ring-primary'}`}
                />
                {errors.name && (
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`transition-all ${errors.password ? 'border-destructive focus:ring-destructive' : 'focus:ring-primary'}`}
                />
                {errors.password && (
                  <p className="text-destructive text-sm flex items-center gap-1">
                    <AlertCircle className="h-4 w-4" />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`transition-all ${errors.confirmPassword ? 'border-destructive focus:ring-destructive' : 'focus:ring-primary'}`}
                />
            ...
            <Button variant="outline" className="w-full hover:bg-accent/50 hover:scale-[1.01]">
              <svg
